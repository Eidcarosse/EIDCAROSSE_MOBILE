export default {
  ...
  partscategory: {
    Autos: "Autos Parts",
    Ebikes: "E-bikes Parts",
    Bicycles: "Bicycles Parts",
    Escooter: "E-scooter Parts",
    Motorcycle: "Motorcycle Parts",
    Boats: "Boats Parts",
    Drones: "Drones Parts",
    ConstructionMachines: "Construction Machines Parts",
    Trucks: "Trucks Parts",
    Vans: "Vans Parts",
  ...
  fuelTypelist: {
    ...
    LPG: "LPG",
    CNG: "CNG",
    Hybridg: "Hybrid (Electric/Gasoline)",
    Hybridd: "Hybrid (Electric/Diesel)",
    Others: "Others",
  },
  truckaxelType: {
    one: "1",
