export default {
  ...
  placeholderKeyword: "enter keyword here...",
  ...
  privacyPolicy: {
    ...
    intro:
      "The creators of the Eidcarosse mobile application prioritize and value the security and privacy of the information you share with us through Eidcarosse. We intend to make our users as comfortable using our app as possible. If you are to trust us with your information, you must understand how we collect, use, and maintain it. When you are about to acquire Eidcarosse, you’ll need to register with us. The registration gives us your First and Last Name, Email Address, and Phone Number.",
    collectionAndUse: {
  ...
  list2: ["Buy and Sell Quickly", "Promote Your Ad", "Banner Advertising"],
  list3: ["About Eidcarosse", "Contact", "Blog"],
  list4: [
    "FAQ",
    "faq",
    "Privacy Policy",
  ...
  faq: {
    ...
    description1:
      "You can easily post your ad; Just tap on the plus (+) icon & then login and submit your ad with proper data. You will get a notification after submitting your ad.",

    title2: "HOW DO I EDIT/DELETE MY ADS?",
    description2:
      "Simply login and go to Account => my listing & you will get a list of your ads. Each ad has a delete option.",
    title3: "HOW TO EDIT MY AD?",
    description3:
      "Simply login and go to Account => my listing & you will get a list of your ads. Each ad has an edit option.",
    title4: "HOW MANY DAYS MY ADS WILL REMAIN ACTIVE?",
    description4:
      "It depends on your settings how many days the listing will be active, depending on it ads will be visible.",
    title5: "HOW MANY ADS CAN I POST FOR FREE?",
    description5:
      "It depends on your settings on the website; sellers will get a number of free ads to post for a certain number of days.",
    ...
    description7:
      "Go to the details of an ad; you will get an email, phone, and chat option. Just tap the chat icon and start your conversation.",
    title8: "WILL I GET CHAT NOTIFICATIONS AS A SELLER?",
    description8:
      "Yes. For chat requests or emails, sellers will get an email notification. For chat, buyers will get the first initial message as an email notification.",
  },
  ...
  sell: {
    ...
    description2:
      "Use clear and actual photos of your product/products. You can use multiple images from different views so buyers will get a clearer idea about your item/items.",

    title3: "PROVIDE CLEAR DESCRIPTION",
    description3:
      "Provide a clear and detailed description of your product. Make sure you've added the right information about your items/items.",
  },

  subList: ["Bicycles", "E-scooter", "E-bikes", "Motorcycle"],
