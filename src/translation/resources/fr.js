export default {
  ...
  flashmsg: {
    ...
    adPosterrormsg: "Quelque chose s'est mal passé lors de la publication de l'annonce",
    requiremsg: "Les champs sont vides",
    editerrormsg: "Quelque chose s'est mal passé lors de l'édition de l'annonce",
    ...
    profileupdateerrormsg: "Quelque chose s'est mal passé lors de la mise à jour du profil",
    updatepassworderrormsg: "Quelque chose s'est mal passé lors du changement de mot de passe",
    wrongpinerrormsg: "Code Pin incorrect",
    emailrequireerrormsg: "Entrez votre e-mail enregistré pour oublier le mot de passe",
