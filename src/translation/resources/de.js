export default {
  ...
  aboutUs: {
    aboutus: "Über uns",
    paraDetail1:
      "Eidcarosse, wir werden von der Leidenschaft angetrieben, Menschen mit den Fahrzeugen, Elektronik, Immobilien, Jobs und Gegenständen zu verbinden, die sie benötigen. Unsere Mission ist es, eine nahtlose und angenehme Erfahrung sowohl für Käufer als auch Verkäufer zu bieten. Mit einem Engagement für benutzerfreundliches Design und leistungsstarke Suchfunktionen haben wir eine Plattform geschaffen, die den Kauf und Verkauf über eine breite Palette von Kategorien hinweg vereinfacht.Unser Team widmet sich der Förderung einer lebendigen Online-Community, in der Einzelpersonen und Unternehmen zusammenkommen können, um genau das zu finden, wonach sie suchen. Egal, ob Sie nach Ihrem Traumauto, den neuesten Gadgets, Ihrem nächsten Zuhause, aufregenden Jobmöglichkeiten oder einzigartigen Gegenständen suchen, Eidcarosse steht Ihnen zur Seite, um Sie durch alles zu führen.Mit Eidcarosse können Sie darauf vertrauen, dass Sie Zugang zu einem vielfältigen Marktplatz erhalten, der Bequemlichkeit, Zuverlässigkeit und Sicherheit priorisiert. Treten Sie noch heute bei und entdecken Sie eine Welt endloser Möglichkeiten direkt an Ihren Fingerspitzen.",
    paraTitle2: "Käufer",
    paraDetail2by1:
  ...
  category: {
    ...
    Bike: "Motorräder",
    Bikes: "Motorräder",
    "Bikes on Installments": "Motorräder auf Raten",
    ...
    Bicycles: "Fahrräder",
    "E-bike": "E-Bike",
    "Industrial & Agriculture Machinery": "Industrie- und Landwirtschaftsmaschinen",
